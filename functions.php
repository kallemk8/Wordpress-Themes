...
function twentyfourteen_paging_nav() {
	...
	if( !function_exists('interval_load_css') ) {
		function interval_load_css(){
			...
			wp_enqueue_style( 'qtip',get_template_directory_uri().'/style/jquery.qtip.css', array(), '1.5');	 	
			...
			wp_enqueue_style( 'animations',get_template_directory_uri().'/style/animations.css', array(), '1.0');	 	
...
class wpb_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php if ( $title ) {
			echo "<h4 class='box_header'>".$title."</h4>";
		} 
		echo "<ul class='blog small clearfix'>";
		...
		<li class="post">
			...
			<div class="post_content">
				<h5>
					<a href="<?php echo get_permalink(); ?>" title="<?php echo get_the_title(); ?>"><?php echo get_the_title(); ?>
					</a>
				</h5>
		...
		<?php
		 ...
		 echo '<a class="more page_margin_top" href="'.home_url().'/category/trailers/">SHOW MORE</a>';
	}
...
class wp_videosongs extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo $args['before_widget']; ?>
		<?php if ( $title ) {
			echo "<h4 class='box_header page_margin_top_section'>".$title."</h4>";
		} 
		echo "<ul class='blog small clearfix'>";
		 while ( $r->have_posts() ) : $r->the_post();
		?>
		...
		<?php
		 ...
		 endwhile; 
		 echo '</ul>';
		  echo '<a class="more sidebar_showmore page_margin_top" href="'.home_url().'/category/'.$cat_name.'">SHOW MORE</a>';
	}
